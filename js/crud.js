...
function onEdit(td) {
    ...
    document.getElementById("año").value = selectedRow.cells[3].innerHTML;
...
function updateRecord(formData) {
    ...
    selectedRow.cells[3].innerHTML = formData.año;
...
function validate() {
    isValid = true;
    if (document.getElementById("fullNameValidationError").value == "") {
        isValid = false;
